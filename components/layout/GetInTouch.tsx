        ...
        <div className="flex flex-col lg:flex-row lg:items-stretch lg:justify-between gap-8 lg:gap-12">
          ...
          <div className="flex flex-col items-start gap-4 pt-4">
            ...
            <Link
              ...
              className="inline-flex w-full items-center justify-center gap-2 rounded-lg bg-[var(--color-accent-dark)] px-6 py-3 text-sm font-label font-semibold uppercase tracking-[0.08em] text-white transition-colors hover:bg-transparent hover:text-black sm:w-auto"
            >
              <ScheduleIcon />
              BOOK A CONVERSATION
            </Link>
